...
const Prices = () => {
  ...
  useEffect(() => {
    console.log(bundleData[0].services);
    ...
    <section className="py-12 lg:py-24">
      <div className="container mx-auto">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-lg text-blue">Choose youe dig category</p>
        </div>
        {/* grid */}
            ...
            return (
              ...
              >
                ...
                <div
                  className={`${
                    index === idx
                      ? "border-b-4 border-orange after:lg:w-5 after:lg:h:5 after:lg:bg-triangle after:lg:bg-no-repeat after:lg:block after:lg:left-[130px] after:lg:absolute after:lg:-bottom-6 relative "
